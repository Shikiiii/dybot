...
async def on_message(message: Message):
    ...
    if(message.content == "!welcome" and (message.author.id == 393839495859929089 or message.author.id == 495680416422821888)):
        ...
        embed2 = discord.Embed(color=0xFF93F0)
        await message.channel.send(embed=embed1)
    elif(message.content == "!staffrules" and (message.author.id == 393839495859929089 or message.author.id == 495680416422821888)):
        embed1 = discord.Embed(title="title goes here", description="and here go the rules", color=0xFF93F0)
        embed2 = discord.Embed(color=0xFF93F0)
        await message.channel.send(embed=embed1)
...
async def nick(ctx, user: discord.Member, *, msg: str):
	role1 = discord.utils.get(ctx.message.author.guild.roles, name="Admin ˚｡☆")
	role2 = discord.utils.get(ctx.message.author.guild.roles, name="Admin ˚｡☆")
	...
	role5 = discord.utils.get(ctx.message.author.guild.roles, name="$ dy")

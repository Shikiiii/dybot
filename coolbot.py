...
async def role(ctx, user: discord.Member, *, rolee: str):
    role = await parse_roles(ctx, rolee)
    roles = ["$ dy", "scope    role1 = discord.utils.get(ctx.message.author.guild.roles, name="$ dy")
    ...
    role28 = discord.utils.get(ctx.message.author.guild.roles, name="Bot Coder")
    role29 = discord.utils.get(ctx.message.author.guild.roles, name="Trial Mod")
    role30 = discord.utils.get(ctx.message.author.guild.roles, name="Chat Moderator")
    role31 = discord.utils.get(ctx.message.author.guild.roles, name="Vc Moderator")
    role32 = discord.utils.get(ctx.message.author.guild.roles, name="Staff")
    role33 = discord.utils.get(ctx.message.author.guild.roles, name="Server Helper")
    role34 = discord.utils.get(ctx.message.author.guild.roles, name="Partnerships Team")
    role35 = discord.utils.get(ctx.message.author.guild.roles, name="Event Manager")
    roles = [role1, role2, role3, role4, role5, role6, role7, role8, role9, role10, role11, role12, role13, role14, role15, role16, role17, role18, role19, role20, role21, role22, role23, role24, role25, role26, role27, role28, role29, role30, role31, role32, role33, role34, role35]
    if role is None:
    ...
    if role in user.roles:
        if role in roles and ctx.message.author.id != 495680416422821888:

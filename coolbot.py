...
async def role(ctx, user: discord.Member, *, rolee: str):
    role = await parse_roles(ctx, rolee)
    roles = ["$ dy", "scopes", "Custom Bot", "Bot Coder", "YAGPDB.xyz", "MEE6", "Sx4", ">.<", "InviteManager", "Owner", "BOTs", "« X »", "Co Owner ??° ?", "? I E N D", "Djimi", "Blitzzy", "BLURY", "GiveawayBot", "Dank Memer", "Groovy", "Community Manager", "appbot", "Head Admin ?°*:?", "Admin °??", "Mod °??", "logs access", "Trial Mod", "Chat Moderator", "Vc Moderator", "Staff", "Server Helper", "Partnerships Team", "Event Manager"]
    if role is None:
